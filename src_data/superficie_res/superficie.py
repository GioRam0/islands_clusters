    ...
    if codice not in superficie_res:
        try:
            ...
            if collection.size().getInfo()==1:
                ...
                #aggiorno il dizionario con l'elevazione massima
            ...
            #se piu di una immagine itero per queste ripetendo il processo
                ...
                for j in range(collection.size().getInfo()):
                    ...
                    #aggiorno l'elevazione massima, se maggiore del valore corrente
            ...
            #trovo le aree protetette che intersecano l'isola, elimino la loro intersezione dalla geometria rimanente dell'isola
            ...
            #per isole grandi calcolo l'area della parte eliminabile e la sottraggo all'area precedente, l'approssimazione rispetto al metodo applicato successivamente per le isole meno grandi è meno rilevante 
            if isl.IslandArea>2000:
                area_eliminabile=lc_geometry.area().getInfo()
                area_finale=max(area-area_eliminabile,0)
            #per le altre sottraggo la geometria e calcolo l'area
            else:
    ...
    if k in lista:
        ...
        if codice not in superficie_res:
            ...
            try:
                ...
                #sottrazione singole aree, non la loro unione
