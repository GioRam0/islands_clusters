...
#risultati uguali tra i diversi random_state
df_common = df_clean[df_clean['config_key'].isin(common_keys)].iloc[0:1]
...
#risultati uguali con random_state diversi
df_common3 = df_clean[df_clean['config_key'].isin(common_keys3)].iloc[0:1]
