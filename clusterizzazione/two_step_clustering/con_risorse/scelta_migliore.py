...
#df_common tutte le run con random state diverso danno lo stesso risultato
df_common = df_clean[df_clean['config_key'].isin(common_keys) & (df['random_state']==42)]
#789 prestazioni globalmente migliore
df_common1 = df_clean[(df_clean['config_key'].isin(common_keys1)) & (df['random_state']==789)]
